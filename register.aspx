...
<body>
    <form id="form3" runat="server">
        <div>
            ...
            <asp:TextBox ID="confirm" runat="server"></asp:TextBox><!--confirm--><asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="CompareValidator" ControlToCompare="pass" ControlToValidate="confirm" Operator="Equal" SetFocusOnError="True"></asp:CompareValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="this field is requierd" ControlToValidate="confirm"></asp:RequiredFieldValidator><br />
