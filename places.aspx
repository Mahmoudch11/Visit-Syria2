<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="places.aspx.cs" Inherits="Visit_Syria.places" %>

<!-- #include file="~/header.html" -->
<div class="carousel-inner">
    <div class="carousel-item active">
        <img src="img/places-cover.jpg" class="d-block w-100 slider-cover" alt="slider" />
        <div class="carousel-caption d-none d-md-block">
            <h5 class="stroke"><span>Long</span> Vacation</h5>
            <p class="stroke">Make it<span>TIMELESS</span> </p>
